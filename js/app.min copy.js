(() => {
  ...
  function t(e, t = !0, s = !0) {
    const i = e.querySelectorAll("a, button, input, textarea, select"),
      a = i[0],
      r = i[i.length - 1];
    t &&
      e.addEventListener("transitionend", (e) => {
        e.target.classList.contains("_show-modal") && a.focus();
      });
    const n = (e) => {
    ...
    s ? e.addEventListener("keydown", n) : e.removeEventListener("keydown", n);
  }
  function s(e) {
    return (
      null !== e &&
  ...
  function i(e = {}, t = {}) {
    Object.keys(t).forEach((a) => {
      void 0 === e[a]
        ? (e[a] = t[a])
        : s(t[a]) && s(e[a]) && Object.keys(t[a]).length > 0 && i(e[a], t[a]);
    });
  }
  const a = {
    body: {},
    ...
    T = {
      ...
      updateSlides: function () {
        ...
        const i = e.params,
          ...
          h = u ? e.virtual.slides.length : c.length;
        let g = [];
        const v = [],
          b = [];
        let E = i.slidesOffsetBefore;
        "function" == typeof E && (E = i.slidesOffsetBefore.call(e));
        ...
        for (let a = 0; a < h; a += 1) {
          ...
          if (
            ((M = 0),
            c[a] && (r = c[a]),
            T && e.grid.updateSlide(a, r, h, t),
            !c[a] || "none" !== f(r, "display"))
          ) {
            if ("auto" === i.slidesPerView) {
              ...
              (M = (n - (i.slidesPerView - 1) * C) / i.slidesPerView),
                i.roundLengths && (M = Math.floor(M)),
                c[a] && (c[a].style[t("width")] = `${M}px`);
        ...
        if (
          ...
          for (let s = 0; s < g.length; s += 1) {
            ...
            i.roundLengths && (a = Math.floor(a)),
              g[s] <= e.virtualSize - n && t.push(a);
          }
          (g = t),
            Math.floor(e.virtualSize - n) - Math.floor(g[g.length - 1]) > 1 &&
              g.push(e.virtualSize - n);
        }
        if (u && i.loop) {
          const t = b[0] + C;
        ...
        if (
          ...
          p(a, "--swiper-centered-offset-before", -g[0] + "px"),
            p(
              a,
      ...
      updateActiveIndex: function (e) {
        ...
        if ((o >= i.length && (o = i.length - 1), u === r))
          return (
  ...
  const F = {
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, a) {
      ...
      if ((r.animating && l.preventInteractionOnTransition) || (!g && !i && !a))
        return !1;
      ...
      if (
        ...
        return (
          ...
          "reset" !== k && (r.transitionStart(s, k), r.transitionEnd(s, k)),
          !1
        );
      if (l.cssMode) {
    ...
    slideNext: function (e = this.params.speed, t = !0, s) {
      ...
      if (r.loop) {
        if (n && !u && r.loopPreventsSliding) return !1;
        ...
        (a = parseInt(
          ...
          t.centeredSlides
            ? r < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (r = e.getSlideIndex(
                  m(s, `${n}[data-swiper-slide-index="${a}"]`)[0],
                )),
                o(() => {
                  e.slideTo(r);
                }))
  ...
  function L(e) {
    ...
    h && c.target && c.target.shadowRoot && m && (p = m[0]);
    const g = n.noSwipingSelector
        ? n.noSwipingSelector
        : `.${n.noSwipingClass}`,
    ...
    const v = o.currentX,
      b = o.currentY,
      k = n.edgeSwipeDetection || n.iOSEdgeSwipeDetection,
      E = n.edgeSwipeThreshold || n.iOSEdgeSwipeThreshold;
    if (k && (v <= E || v >= i.innerWidth - E)) {
      if ("prevent" !== k) return;
      e.preventDefault();
    }
    Object.assign(a, {
  ...
  function P(e) {
    ...
    if (s.params.threshold && Math.sqrt(g ** 2 + f ** 2) < s.params.threshold)
      return;
    ...
    const E = s.params.loop && !a.cssMode;
    if (!i.isMoved) {
      if (
        (E && s.loopFix({ direction: s.swipeDirection }),
  ...
  function B(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? m >= l[e] && m < l[e + t] && ((g = e), (f = l[e + t] - l[e]))
        : m >= l[e] && ((g = e), (f = l[l.length - 1] - l[l.length - 2]));
    }
    let v = null,
      b = null;
    a.rewind &&
    ...
    if (h > a.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (k >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? v : g + E)
          : t.slideTo(g)),
        "prev" === t.swipeDirection &&
          (k > 1 - a.longSwipesRatio
            ? t.slideTo(g + E)
            : null !== b && k < 0 && Math.abs(k) > a.longSwipesRatio
              ? t.slideTo(b)
              : t.slideTo(g));
    } else {
      ...
      (c.target !== t.navigation.nextEl && c.target !== t.navigation.prevEl)
        ? ("next" === t.swipeDirection && t.slideTo(null !== v ? v : g + E),
  ...
  const q = (e, t) => {
      const s = r(),
        ...
        d = t;
      a[u]("pointerdown", e.onTouchStart, { passive: !1 }),
        s[u]("pointermove", e.onTouchMove, { passive: !1, capture: o }),
        ...
        i.cssMode && n[u]("scroll", e.onScroll),
      ...
      translate: {
        ...
        setTranslate: function (e, t) {
          ...
          let l,
            o = 0,
            u = 0;
          s.isHorizontal() ? (o = i ? -e : e) : (u = e),
            a.roundLengths && ((o = Math.floor(o)), (u = Math.floor(u))),
            (s.previousTranslate = s.translate),
            (s.translate = s.isHorizontal() ? o : u),
            a.cssMode
              ...
              : a.virtualTranslate ||
                ...
                (r.style.transform = `translate3d(${o}px, ${u}px, 0px)`));
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = L.bind(e)),
            ...
            (e.onClick = I.bind(e)),
            (e.onLoad = V.bind(e)),
            z || (t.addEventListener("touchstart", R), (z = !0)),
            q(e, "on");
        },
  ...
  class Y {
    constructor(...e) {
      ...
      a.__swiper__ = true;
      a.support = y();
      a.device = function (options = {}) {
        if (!w) {
          w = (function ({ userAgent } = {}) {
            const support = y();
            const windowObj = l();
            const platform = windowObj.navigator.platform;
            const ua = userAgent || windowObj.navigator.userAgent;
            const device = {
              ios: false,
              android: false,
            };
            const screenWidth = windowObj.screen.width;
            const screenHeight = windowObj.screen.height;
            const androidMatch = ua.match(/(Android);?[\s\/]+([\d.]+)?/);
            let ipadMatch = ua.match(/(iPad).*OS\s([\d_]+)/);
            const ipodMatch = ua.match(/(iPod)(.*OS\s([\d_]+))?/);
            const iphoneMatch =
              !ipadMatch && ua.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
            const isWindows = platform === "Win32";
            let isMac = platform === "MacIntel";
            if (!ipadMatch && isMac && support.touch) {
              ...
              if (iPadResolutions.includes(`${screenWidth}x${screenHeight}`)) {
                ipadMatch = ua.match(/(Version)\/([\d.]+)/) || [0, 1, "13_0_0"];
                isMac = false;
              }
            }
            if (androidMatch && !isWindows) {
              device.os = "android";
              device.android = true;
            }
            if (ipadMatch || iphoneMatch || ipodMatch) {
              device.os = "ios";
              device.ios = true;
            }
            return device;
  ...
  function X({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      (t = a(t)), (s = a(s));
      const i = (t, s) => {
        t.removeEventListener("click", "next" === s ? u : o),
  ...
  function Z({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    s("changeDirection", () => {
      ...
      s("init", () => {
        !1 === e.params.pagination.enabled ? g() : (h(), p(), c());
      }),
      s("activeIndexChange", () => {
  ...
  function J({ swiper: e, extendParams: t, on: s, emit: i, params: a }) {
    let n, l;
    ...
    function b(t) {
      e &&
        ...
        (e.wrapperEl.removeEventListener("transitionend", b), C());
    }
    const k = () => {
        if (e.destroyed || !e.autoplay.running) return;
        e.autoplay.paused ? (u = !0) : u && ((f = o), (u = !1));
        const t = e.autoplay.paused ? o : v + f - new Date().getTime();
      ...
      w = () => {
        (e.autoplay.running = !0), E(), i("autoplayStart");
      },
      S = () => {
      ...
      y = (t, s) => {
        ...
        if (((e.autoplay.paused = !0), s))
          return h && (o = e.params.autoplay.delay), (h = !1), void a();
      ...
      _ = () => {
        if (e.destroyed || !e.autoplay.running) return;
        const t = r();
        "hidden" === t.visibilityState && ((m = !0), y(!0)),
          "visible" === t.visibilityState && C();
      },
      x = (e) => {
        "mouse" === e.pointerType && ((m = !0), y(!0));
      },
      A = (t) => {
    ...
    s("init", () => {
      e.params.autoplay.enabled &&
        (e.params.autoplay.pauseOnMouseEnter &&
          (e.el.addEventListener("pointerenter", x),
          e.el.addEventListener("pointerleave", A)),
        r().addEventListener("visibilitychange", _),
        (v = new Date().getTime()),
        w());
    }),
      s("destroy", () => {
        e.el.removeEventListener("pointerenter", x),
          e.el.removeEventListener("pointerleave", A),
          r().removeEventListener("visibilitychange", _),
          e.autoplay.running && S();
      }),
      s("beforeTransitionStart", (t, s, i) => {
        !e.destroyed &&
          e.autoplay.running &&
          (i || !e.params.autoplay.disableOnInteraction ? y(!0, !0) : S());
      }),
      s("sliderFirstMove", () => {
        !e.destroyed &&
          e.autoplay.running &&
      ...
      s("touchEnd", () => {
        if (!e.destroyed && e.autoplay.running && d) {
          if (
            ...
            return (c = !1), void (d = !1);
          c && e.params.cssMode && C(), (c = !1), (d = !1);
        }
      }),
      s("slideChange", () => {
        !e.destroyed && e.autoplay.running && (h = !0);
      }),
      Object.assign(e.autoplay, { start: w, stop: S, pause: y, resume: C });
  }
  let Q;
  const ee = {
      initModal() {
        document.addEventListener("click", function (e) {
          if (e.target.closest("[data-modal]")) {
            const t = e.target.closest("[data-modal]").dataset.modal;
            if (t) {
              const s = document.getElementById(t),
                i =
                  (s.querySelector("._modal-body"),
                  s.querySelector("._modal-content"));
              (Q = e.target), ee.openModal(s, i);
            }
          }
          if (
            e.target.closest("._close-modal") ||
            e.target.classList.contains("_modal-body")
          ) {
            const t = e.target.closest("._modal-wrapper"),
              s =
                (t.querySelector("._modal-body"),
                t.querySelector("._modal-content"));
            ee.closeModal(t, s, Q);
          }
        }),
          document.addEventListener("keydown", function (e) {
            ("Escape" !== e.key && 27 !== e.keyCode) ||
              document.querySelectorAll("._modal-wrapper").forEach((e) => {
                if (e) {
                  const t = e.querySelector("._modal-content");
                  ee.closeModal(e, t, Q);
                }
              });
          });
        ...
        if (e) {
          const t = document.getElementById(e),
            s =
              (t.querySelector("._modal-body"),
              t.querySelector("._modal-content"));
          (Q = document.activeElement), ee.openModal(t, s);
        }
      },
      openModal(s, i) {
        (document.body.style.paddingRight = `${e()}px`),
          ...
          s.classList.add("_show-modal"),
          i.classList.add("_show-modal"),
          t(s);
      },
      closeModal(e, t, s) {
        document.body.classList.remove("_lock"),
          ...
          document.querySelector(".header__wrapper") &&
            (document.querySelector(".header__wrapper").style.paddingRight =
              "0px"),
          e.classList.remove("_show-modal"),
          t.classList.remove("_show-modal"),
          s && s.focus();
      },
    },
    te = ee.initModal;
  ...
  function ce(e) {
    return Array.isArray(e) ? e : [e, new ie()];
  }
  function pe(e, t) {
    if (t === e) return !0;
    var s,
    ...
    if (i && a) {
      ...
      for (s = 0; s < t.length; s++) if (!pe(t[s], e[s])) return !1;
      return !0;
    }
    if (i != a) return !1;
    if (t && e && "object" == typeof t && "object" == typeof e) {
      var r = t instanceof Date,
        n = e instanceof Date;
      if (r && n) return t.getTime() == e.getTime();
      if (r != n) return !1;
      ...
      for (s = 0; s < u.length; s++) if (!pe(e[u[s]], t[u[s]])) return !1;
      return !0;
    }
    return (
  ...
  class fe {
    constructor(e) {
      (this._value = ""),
        this._update(Object.assign({}, fe.DEFAULTS, e)),
      ...
      let e =
        ...
        t =
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : this.value.length;
      return new me(this.extractInput(e, t), e);
    }
    appendTail(e) {
      return ae(e) && (e = new me(String(e))), e.appendTo(this);
    }
    _appendCharRaw(e) {
      return e
        ? ((this._value += e), new ie({ inserted: e, rawInserted: e }))
        : new ie();
    }
    _appendChar(e) {
      let t =
      ...
      if (
        ...
        if (r && null != s) {
          const t = this.state;
          !0 === this.overwrite &&
            ((e = s.state), s.unshift(this.value.length - a.tailShift));
        ...
        r || ((a = new ie()), (this.state = i), s && e && (s.state = e));
      }
      return a;
    }
    _appendPlaceholder() {
    ...
    append(e, t, s) {
      if (!ae(e)) throw new Error("value should be string");
      const i = new ie(),
        a = ae(s) ? new me(String(s)) : s;
      null != t && t.tail && (t._beforeTailState = this.state);
      for (let s = 0; s < e.length; ++s) {
        const r = this._appendChar(e[s], t, a);
        if (!r.rawInserted && !this.doSkipInvalid(e[s], t, a)) break;
        i.aggregate(r);
      }
      return (
      ...
      let e =
        ...
        t =
          arguments.length > 1 && void 0 !== arguments[1]
            ...
            : this.value.length;
      return (
        (this._value = this.value.slice(0, e) + this.value.slice(t)), new ie()
      );
    }
    withValueRefresh(e) {
    ...
    splice(e, t, s, i) {
      ...
      l &&
        ...
        (o = this.extractInput(0, r, { raw: !0 })));
      let u = e;
      const d = new ie();
      if (
        (i !== re &&
          ((u = this.nearestInputPos(e, t > 1 && 0 !== e && !l ? re : i)),
          (d.tailShift = u - e)),
        d.aggregate(this.remove(u)),
        l && i !== re && o === this.rawInputValue)
      )
        if (i === le) {
          let e;
          for (; o === this.rawInputValue && (e = this.value.length); )
            d.aggregate(new ie({ tailShift: -1 })).aggregate(
              this.remove(e - 1),
            );
        } else i === ue && n.unshift();
      return d.aggregate(this.append(s, a, n));
    }
    maskEquals(e) {
      return this.mask === e;
    }
    typedValueEquals(e) {
      ...
      return (
        e === t ||
        (fe.EMPTY_VALUES.includes(e) && fe.EMPTY_VALUES.includes(t)) ||
        ...
        : e instanceof Date || e === Date
          ...
          : e instanceof Number || "number" == typeof e || e === Number
            ...
            : Array.isArray(e) || e === Array
              ? ge.MaskedDynamic
              : ge.Masked && e.prototype instanceof ge.Masked
                ? e
                : e instanceof ge.Masked
                  ? e.constructor
                  : e instanceof Function
                    ? ge.MaskedFunction
                    : (console.warn("Mask not found for mask", e), ge.Masked);
  }
  function be(e) {
    if (ge.Masked && e instanceof ge.Masked) return e;
    const t = (e = Object.assign({}, e)).mask;
    if (ge.Masked && t instanceof ge.Masked) return t;
    const s = ve(t);
    if (!s)
      throw new Error(
  ...
  (fe.DEFAULTS = { format: String, parse: (e) => e, skipInvalid: !0 }),
  ...
  class we {
    ...
    _appendChar(e) {
      let t =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      if (this.isFilled) return new ie();
  ...
  class Ce {
    ...
    appendTo(e) {
      if (!(e instanceof ge.MaskedPattern))
        return new me(this.toString()).appendTo(e);
      const t = new ie();
    ...
    set state(e) {
      ...
      Object.assign(this, s),
        (this.chunks = t.map((e) => {
          const t = "chunks" in e ? new Ce() : new me();
          return (t.state = e), t;
        }));
    }
    unshift(e) {
  ...
  class _e {
    ...
    pushLeftBeforeFilled() {
      return this._pushLeft(() => {
        if (!this.block.isFixed && this.block.value)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, le)),
    ...
    pushRightBeforeFilled() {
      return this._pushRight(() => {
        if (!this.block.isFixed && this.block.value)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, ue)),
    ...
    pushRightBeforeInput() {
      return this._pushRight(() => {
        if (!this.block.isFixed)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, re)), !0
          );
      });
    }
  ...
  ge.MaskedRegExp = class extends fe {
    _update(e) {
  ...
  class Ae extends fe {
    constructor() {
      let e =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      (e.definitions = Object.assign({}, Ee, e.definitions)),
        super(Object.assign({}, Ae.DEFAULTS, e));
    }
    _update() {
      let e =
        arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    ...
    _rebuildMask() {
      ...
      for (let n = 0; n < t.length; ++n) {
        ...
        const u =
            ...
            (null === (r = e[l]) || void 0 === r
              ? void 0
              : r.mask.prototype) instanceof ge.Masked
              ? { mask: e[l] }
              : e[l],
          d = o
            ? new we(
            ...
            : new Se({ char: l, eager: this.eager, isUnmasking: s });
        this._blocks.push(d);
      }
    }
    get state() {
    ...
    _mapPosToBlock(e) {
      ...
      for (let s = 0; s < this._blocks.length; ++s) {
        const i = this._blocks[s],
          a = t.length;
        if (((t += i.value), e <= t.length)) return { index: s, offset: e - a };
      }
    }
    _blockStartPos(e) {
    ...
    _forEachBlocksInRange(e) {
      ...
      if (i) {
        const e = this._mapPosToBlock(t),
          a = e && i.index === e.index,
          r = i.offset,
          n = e && a ? e.offset : this._blocks[i.index].value.length;
          ...
          s.pushRightBeforeFilled()
            ...
            : t === ue
              ...
              : (s.popState(),
                s.ok
                  ? s.pos
                  : (s.popState(), s.ok ? s.pos : this.nearestInputPos(e, ne))))
        : e;
    }
    maskedBlock(e) {
  ...
  (Ae.DEFAULTS = { lazy: !0, placeholderChar: "_" }),
    (Ae.STOP_CHAR = "`"),
    (Ae.ESCAPE_CHAR = "\\"),
    (Ae.InputDefinition = we),
    (Ae.FixedDefinition = Se),
    (ge.MaskedPattern = Ae);
  class Te extends Ae {
    get _matchFrom() {
    ...
    _update(e) {
      ...
      (e.mask = i.slice(0, a).replace(/0/g, "\\0") + "0".repeat(t - a)),
        super._update(e);
    }
    get isComplete() {
    ...
    doPrepare(e) {
      ...
      if (
        (([e, t] = ce(super.doPrepare(e.replace(/\D/g, ""), s))),
        !this.autofix || !e)
      )
        return e;
  ...
  class Me extends Ae {
    constructor(e) {
      super(Object.assign({}, Me.DEFAULTS, e));
    }
    _update(e) {
      e.mask === Date && delete e.mask, e.pattern && (e.mask = e.pattern);
      const t = e.blocks;
      (e.blocks = Object.assign({}, Me.GET_DEFAULT_BLOCKS())),
  ...
  class Le extends Fe {
    ...
    bindEvents(e) {
      Object.keys(e).forEach((t) =>
        this._toggleEventHandler(Le.EVENTS_MAP[t], e[t]),
      );
    }
    unbindEvents() {
  ...
  ge.HTMLContenteditableMaskElement = Pe;
  const Be = ["mask"];
  (ge.InputMask = class {
    constructor(e, t) {
      (this.el =
    ...
    maskEquals(e) {
      ...
      return (
        null == e ||
        (null === (t = this.masked) || void 0 === t ? void 0 : t.maskEquals(e))
      );
    }
    set mask(e) {
      if (this.maskEquals(e)) return;
      if (!(e instanceof ge.Masked) && this.masked.constructor === ve(e))
    ...
    alignCursor() {
      this.cursorPos = this.masked.nearestInputPos(
        this.masked.nearestInputPos(this.cursorPos, ne),
      );
    }
    alignCursorFriendly() {
    ...
    _onInput(e) {
      ...
      const t = new he(
        ...
        a = s === this.masked.rawInputValue ? t.removeDirection : re;
      let r = this.masked.nearestInputPos(t.startChangePos + i, a);
      a !== re && (r = this.masked.nearestInputPos(r, re)),
        this.updateControl(),
        this.updateCursor(r),
    ...
    (ge.MaskedEnum = class extends Ae {
      _update(e) {
  ...
  class De extends fe {
    constructor(e) {
      super(Object.assign({}, De.DEFAULTS, e));
    }
    _update(e) {
    ...
    _updateRegExps() {
      let e = "^" + (this.allowNegative ? "[+|\\-]?" : ""),
        t =
          (this.scale
            ? "(".concat(de(this.radix), "\\d{0,").concat(this.scale, "})?")
            : "") + "$";
      (this._numberRegExp = new RegExp(e + "\\d*" + t)),
        (this._mapToRadixRegExp = new RegExp(
          "[".concat(this.mapToRadix.map(de).join(""), "]"),
          "g",
        )),
    ...
    doPrepare(e) {
      ...
      const [s, i] = ce(super.doPrepare(e, t));
    ...
    _appendCharRaw(e) {
      ...
      const a = super._appendCharRaw(e, t);
      ...
      return (
        ...
        (a.skip = !a.rawInserted && e === this.thousandsSeparator),
        a
      );
    }
    ...
    remove() {
      ...
      return new ie({ tailShift: (r - a) * this.thousandsSeparator.length });
    }
    nearestInputPos(e, t) {
      ...
      switch (t) {
        ...
        case le: {
          ...
          if (s >= 0) {
            ...
            if (e < i || this.value.length <= i || t === le) return s;
          }
          break;
        }
        case oe:
    ...
    get unmaskedValue() {
      ...
      ).replace(this.radix, De.UNMASKED_RADIX);
    }
    set unmaskedValue(e) {
      super.unmaskedValue = e;
    }
    ...
    typedValueEquals(e) {
      return (
        (super.typedValueEquals(e) ||
          (De.EMPTY_VALUES.includes(e) &&
            De.EMPTY_VALUES.includes(this.typedValue))) &&
        !(0 === e && "" === this.value)
      );
    }
  }
  (De.UNMASKED_RADIX = "."),
    ...
    (De.EMPTY_VALUES = [...fe.EMPTY_VALUES, 0]),
    (ge.MaskedNumber = De),
    (ge.MaskedFunction = class extends fe {
      _update(e) {
        e.mask && (e.validate = e.mask), super._update(e);
      }
    });
  const Ie = ["compiledMasks", "currentMaskRef", "currentMask"],
    Oe = ["mask"];
  class Ve extends fe {
    constructor(e) {
      super(Object.assign({}, Ve.DEFAULTS, e)), (this.currentMask = null);
    }
    _update(e) {
      super._update(e),
        "mask" in e &&
      ...
      if (
        ...
        if (this.currentMask !== n) {
          if ((this.currentMask.reset(), a)) {
            ...
            l.tailShift = e.inserted.length - s.length;
          }
          r &&
    ...
    _appendPlaceholder() {
      ...
      return (
        this.currentMask && e.aggregate(this.currentMask._appendPlaceholder()),
        e
      );
    }
    _appendEager() {
    ...
    doPrepare(e) {
      let t =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
        [s, i] = ce(super.doPrepare(e, t));
      if (this.currentMask) {
        let e;
        ([s, e] = ce(super.doPrepare(s, this.currentMaskFlags(t)))),
          (i = i.aggregate(e));
      }
      return [s, i];
    }
    ...
    get isComplete() {
      var e;
      return Boolean(
        null === (e = this.currentMask) || void 0 === e ? void 0 : e.isComplete,
      );
    }
    get isFilled() {
      var e;
    ...
    set skipInvalid(e) {
      (this.isInitialized || e !== fe.DEFAULTS.skipInvalid) &&
        console.warn(
    ...
    maskEquals(e) {
      return (
        ...
        this.compiledMasks.every((t, s) => {
          ...
          const i = e[s],
            { mask: a } = i;
          return pe(t, se(i, Oe)) && t.maskEquals(a);
        })
      );
    }
    typedValueEquals(e) {
  ...
  (Ve.DEFAULTS = {
    dispatch: (e, t, s) => {
      ...
      const i = t.rawInputValue,
        a = t.compiledMasks.map(
          (a, r) => (
            a.reset(),
            a.append(i, { raw: !0 }),
            a.append(e, t.currentMaskFlags(s)),
            { weight: a.rawInputValue.length, index: r }
          ),
        );
      return a.sort((e, t) => t.weight - e.weight), t.compiledMasks[a[0].index];
    },
  }),
    (ge.MaskedDynamic = Ve);
  const ze = {
  ...
  const qe = {
          ...
          return (
            t.forEach((t) => {
              "email" === t.dataset.required
                ? qe.emailTest(t) || (qe.addError(t), e++)
                : "checkbox" === t.dataset.required
                  ? t.checked || (qe.addError(t), e++)
                  : "tel" === t.dataset.required
                    ? qe.telTest(t) || (qe.addError(t), e++)
                    : "en|ru|ua" === t.dataset.required
                      ? qe.nameTest(t) || (qe.addError(t), e++)
                      : "num" === t.dataset.required
                        ? qe.numTest(t) || (qe.addError(t), e++)
                        : "minmax" === t.dataset.required
                          ? qe.minmax(t) || (qe.addError(t), e++)
                          : "file" === t.dataset.required && "" !== t.value
                            ? qe.fileUpload(t) || (qe.addError(t), e++)
                            : "" === t.value && (qe.addError(t), e++);
            }),
            e
          );
        }
      ...
      viewPass(e) {
        e.querySelectorAll("[type=password]").forEach((t) => {
          e.addEventListener("click", (s) => {
            if (s.target.closest("[data-show-password]")) {
              const s = e.querySelector("[data-show-password] use");
              "password" === t.type
                ? (t.setAttribute("type", "text"),
                  s.setAttribute("href", "./sprites/sprite.svg#icon-eye-open"))
                : (t.setAttribute("type", "password"),
                  s.setAttribute(
                    "href",
                    "./sprites/sprite.svg#icon-eye-closed",
                  ));
            }
          });
        });
      ...
      filePreview(e) {
        const t = e.querySelector("[type=file]"),
          s = e.querySelector("._files-container");
        let i = [];
        t.addEventListener("change", () => {
          const e = Array.from(t.files).filter((e) => qe.fileValidation(e));
          if (i.length + e.length > 3)
            return (
              event.stopPropagation(),
              event.preventDefault(),
              alert("Максимальное количество файлов: 3"),
              !1
            );
          (i = [...i, ...e]), (s.innerHTML = "");
          for (let e = 0; e < i.length; e++) {
            ...
            a.readAsDataURL(t),
              (a.onload = function (t) {
                ...
                i.classList.add("_file-preview-content"),
                  (i.src = t.target.result),
                  (i.alt = "Завантажене зображення");
                const a = document.createElement("button");
                a.classList.add("_file-delete-button"),
                  (a.dataset.delete = e),
                  (a.textContent = "Удалить");
                const r = document.createElement("div");
                r.classList.add("_file-wrapper"),
                  r.classList.add("_imw"),
                  r.appendChild(i),
                  r.appendChild(a),
                  s.appendChild(r);
              }),
          ...
          s.addEventListener("click", (e) => {
            if (e.target.classList.contains("_file-delete-button")) {
              const t = e.target.dataset.delete;
              i.splice(t, 1);
              const a = e.target.closest("._file-wrapper");
              s.removeChild(a),
                s.querySelectorAll("._file-wrapper").forEach((e, t) => {
                  e.querySelector("._file-delete-button").dataset.delete = t;
                });
            }
          }),
          document
      ...
      fileValidation: (e) =>
        ["image/jpeg", "image/png", "image/gif"].includes(e.type)
          ? !(e.size > 2097152 && (alert("Не більше 2 мегабайт!"), 1))
          : (alert("Тільки зображення!"), !1),
      formFullReset(e) {
        (e.querySelector(".file-preview").innerHTML = ""), e.reset();
      },
      addError(e) {
        if (
          ...
          const t = e.closest(".file").querySelector(".form-text-error");
          t && e.closest(".file").removeChild(t),
            e.hasAttribute("data-error") &&
              e
                .closest(".file")
                .insertAdjacentHTML(
                  "beforeend",
                  `<div class="form-text-error">${e.dataset.error}</div>`,
                );
        } else {
          const t = e.parentElement.querySelector(".form-text-error");
      ...
      removeError(e) {
        e.classList.remove("_form-error"),
          ...
          e.parentElement.querySelector(".form-text-error")
            ? e.parentElement.removeChild(
                e.parentElement.querySelector(".form-text-error"),
              )
            : "file" === e.type &&
              e.closest(".file").querySelector(".form-text-error") &&
              e
                .closest(".file")
                .removeChild(
                  e.closest(".file").querySelector(".form-text-error"),
      ...
      nameTest: (e) =>
        /^([А-Яа-яЪъЁёЫыэЭ\s]+|[a-zA-Z\s]+|[а-щА-ЩЬьЮюЯяЇїІіЄєҐґ\s]+)$/.test(
          e.value,
        ),
      numTest: (e) => /^[0-9]*$/.test(e.value),
      minmax: (e) => e.value.length > 5 && e.value.length < 10,
    },
    $e = qe.hasErrors;
  qe.filePreview,
    qe.viewPass,
    ...
    document.addEventListener("DOMContentLoaded", function () {
      console.log(
        "%cЗроблено з натхненням! %chttps://www.instagram.com/dmitry_conquer/",
        "color: #8AC6E8; font-size: 14px; padding: 10px 0;",
        "color: blue; font-size: 11px; padding: 5px 0;",
      ),
        (function (e = "max") {
          ...
          [
            ...new Set(
              i.map(({ breakpoint: t }) => `(${e}-width: ${t}px),${t}`),
            ),
          ]
            .map((e) => {
              const [t, s] = e.split(",");
              return { query: t, breakpoint: s };
            })
            .forEach((e) => {
              const s = window.matchMedia(e.query),
                a = (function (e, s) {
                  return function () {
                    e.matches
                      ? (s.forEach((e) => {
                          !(function (e) {
                            const { to: s, element: i, order: a } = e;
                            (e.index = (function (e, t) {
                              return [...t.children].indexOf(e);
                            })(e.element, e.element.parentElement)),
                              i.classList.add(t),
                              "last" === a || a >= s.children.length
                                ? s.append(i)
                                : "first" !== a
                                  ? s.children[a].before(i)
                                  : s.prepend(i);
                          })(e);
                        }),
                        s.reverse())
                      : (s.forEach((e) => {
                          e.element.classList.contains(t) &&
                            (function (e) {
                              const { parent: s, element: i, index: a } = e;
                  ...
                  s,
                  i.filter(({ breakpoint: t }) => t === e.breakpoint),
                );
              s.addEventListener("change", a), a();
            });
        })("max"),
        (function () {
          const e = document.querySelector(".header");
          if (e) {
            const s = document.querySelector("._menu-icon"),
              i = document.querySelector("._menu-header"),
            ...
            window.innerWidth < 991.98 &&
              ...
              document.addEventListener("click", (e) => {
                const r = e.target;
                (r.classList.contains("_menu-icon") ||
                  r.closest("._menu-icon")) &&
                  (document.body.classList.toggle("_lock"),
                  s.classList.toggle("_active-menu-icon"),
                  i.classList.toggle("_active-menu-header"),
                  i.querySelectorAll("._menu-item").forEach((e, t) => {
                    e.style.setProperty("--i", `${t}`),
                      e.classList.toggle("_anim-menu-item");
                  }),
                  i.classList.contains("_active-menu-header")
                    ? (t(a, !1, !0),
                      i
                        .querySelectorAll("a, button, input, textarea, select")
                        .forEach((e) => {
                  ...
                  r.closest("._menu-link") &&
                    (document.body.classList.remove("_lock"),
                    s.classList.remove("_active-menu-icon"),
                    i.classList.remove("_active-menu-header"),
                    i.querySelectorAll("._menu-item").forEach((e) => {
                      e.classList.remove("_anim-menu-item");
                    }),
                    t(a, !1, !1),
                    i
                      .querySelectorAll("a, button, input, textarea, select")
            ...
            function n() {
              ...
              t > r && !e.classList.contains("_scroll")
                ? e.classList.add("_scroll")
                : t < r &&
                  e.classList.contains("_scroll") &&
        ...
        (function () {
          if (
            (document.querySelector(".trust__slider") &&
              new U(".trust__slider", {
                modules: [J],
                wrapperClass: "trust__list",
            ...
            document.querySelector(".slider-products"))
          ) {
            let e;
            e = new U(".slider-products", {
              modules: [X, Z, J],
              wrapperClass: "slider-products__wrapper",
              slideClass: "slide-products",
              slidesPerView: 3,
              spaceBetween: 30,
              speed: 800,
              observer: !0,
              ...
              pagination: { el: ".slider-products__pagination", clickable: !0 },
              navigation: {
                prevEl: ".slider-products__button_prev",
                nextEl: ".slider-products__button_next",
              },
              breakpoints: {
                320: { slidesPerView: 1, spaceBetween: 20 },
                575.98: { slidesPerView: 1, spaceBetween: 50 },
                767.98: { slidesPerView: 2, spaceBetween: 30 },
                991.98: { slidesPerView: 3, spaceBetween: 30 },
              },
            });
          }
          if (document.querySelector(".slider-comments")) {
            let t;
            (t = new U(".slider-comments", {
              modules: [X, J],
              wrapperClass: "slider-comments__wrapper",
              slideClass: "slide-comments",
              slidesPerView: "auto",
              spaceBetween: 30,
              speed: 800,
              observer: !0,
              ...
              navigation: {
                prevEl: ".comments__slider-button_prev",
                nextEl: ".comments__slider-button_next",
              },
              on: {
                init: function (e) {
                  const t = document.querySelector(".controll-comments__all"),
                    s = document.querySelector(".controll-comments__current");
                  (t.innerHTML =
                    e.slides.length < 10
                      ? `0${e.slides.length}`
                      : e.slides.length),
          ...
          if (document.querySelector(".slider-instagram")) {
            let s;
            function i() {
              window.innerWidth <= 991.98
                ? s ||
                  (s = new U(".slider-instagram", {
                    modules: [],
                    wrapperClass: "slider-instagram__wrapper",
                    slideClass: "slide-instagram",
                    slidesPerView: "auto",
                    spaceBetween: 30,
                    speed: 800,
                    observer: !0,
            ...
            document.querySelector(".slider-instagram"), i();
            const a = (e, t) => {
              let s = !1;
              return () => {
                s ||
            ...
            window.addEventListener("resize", a(i, 300));
          }
        })(),
        document.addEventListener("click", (e) => {
          const t = e.target.closest("[data-tab-caption]");
          if (!t) return;
          const s = t.closest("._tab"),
            i = t.dataset.tabCaption,
            a = s.querySelector(`[data-tab-content='${i}']`);
          a &&
            (s
              .querySelectorAll("[data-tab-caption]")
              .forEach((e) => e.classList.remove("_active-tab-caption")),
            s
              .querySelectorAll("[data-tab-content]")
              .forEach((e) => e.classList.remove("_active-tab-content")),
            t.classList.add("_active-tab-caption"),
            a.classList.add("_active-tab-content"),
            a.querySelectorAll("._animated").forEach((e, t) => {
              e.classList.contains("_tab-content-anim") ||
                (e.style.setProperty("--i", `${t}`),
                e.classList.add("_tab-content-anim"),
                setTimeout(() => {
                  e.classList.remove("_tab-content-anim");
                }, 1200));
            }));
        }),
        te(),
        document.addEventListener("click", function (e) {
          e.target.closest(".slide-products__image") && e.preventDefault();
        });
      const e = document.querySelector(".form-connect"),
        s = document.querySelector(".form-connect__button");
      s &&
        s.addEventListener("click", () => {
          0 == $e(e)
            ? (window.location.href = "thanks.html")
            : alert("Некоректно заповнені поля форми!");
        }),
        e &&
          e.addEventListener("focusin", (e) => {
            if ("tel" === e.target.dataset.mask) {
              const t = { mask: "+{38}(000)000-00-00", lazy: !1 };
              ge(e.target, t);
            }
            if ("num-only" === e.target.dataset.mask) {
              const t = { mask: /^[0-9]{1,6}$/ };
              ge(e.target, t);
            }
          });
    });
